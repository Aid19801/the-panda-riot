...
const BringerIcon = () => (
	<div className="bringer-svg">
		<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 561 561" style={{ enableBackground: 'new 0 0 561 561' }}>
			<g>
				<g>
